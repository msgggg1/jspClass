...
<title>2025. 5. 29. 오후 2:17:36</title>
...
<div>
  ...
  <jsp:useBean id="mi" class="days07.MemberInfo" scope="page"></jsp:useBean><!-- input태그 이름값, 자바빈즈 이름 동일해야함 -->
  <jsp:setProperty property="*" name="mi"/><!-- mi.setId(id);  id라고 적었지만 setter(setId)를 준 것임. 따라서 @Setter없으면 오류-->
